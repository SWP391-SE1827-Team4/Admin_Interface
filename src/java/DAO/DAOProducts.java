...
//    }
    public List<Product> getAllProducts() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                product.setCreated_At(rs.getString(9));
                product.setUpdated_At(rs.getString(10));
                list.add(product);
            }
        } catch (Exception ex) {
    ...
    public int InsertProduct(Product product) {
        try {
            ...
            stm.setString(9, product.getUpdated_At());
            stm.executeUpdate();
    ...
    public void updateProduct(Product p) {
        try {
            ...
            stm.setString(8, p.getCreated_At());
            stm.setString(9, p.getUpdated_At());
